    ...
    <Disclosure>
        {({ close }) => (
          <>
            ...
            <Disclosure.Button className={`flex grow justify-between rounded-lg px-4 py-2 text-left text-sm font-medium focus:outline-none focus-visible:ring focus-visible:ring-opacity-75 ${disclosureColors}`}>
              <FileNameWithId
